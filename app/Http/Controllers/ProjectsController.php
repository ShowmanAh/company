...
//$projectuser=ProjectUser::where('user_id',$user->id)->where('project_id',$project->id)->first();
        //if ($projectuser) {
        //  return redirect()->route('projects.show',['project'=>$project->id])->with('success',$request->input('email').'is already member of projects');
    ...
    public function store(Request $request)
    {
      if (Auth::check()) {
       ...
       if ($project) {
         ...
         return back()->withInput('error','error company create');
    }
    ...
    public function update(Request $request, Project $project)
    {
      ...
      return back()->withInput('error','error company update');
    }
    ...
    public function destroy(Project $project)
    {
      $findproject=Project::find($project->id);
        ...
        return back()->withInput('error','Project coudnt be deleted');
      }
